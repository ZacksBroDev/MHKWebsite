...
const mockResponses = {
  ...
  users: {
    ...
    users: [
      {
        _id: "1",
        email: "admin@mhktraining.com",
        role: "admin",
        createdAt: new Date().toISOString(),
      },
      {
        _id: "2",
        email: "sensei@mhktraining.com",
        role: "admin",
        createdAt: new Date().toISOString(),
      },
      {
  ...
  events: {
    ...
    events: [
      // November 2025 Events - Full Month Schedule
      {
        ...
        description:
          "Introduction to martial arts fundamentals and basic techniques",
        level: "Beginner",
      },
      {
        _id: "2",
        ...
        description:
          "Karate class designed specifically for children ages 6-12",
        level: "Youth",
      },
      {
        _id: "3",
      ...
      },
      {
        ...
        description:
          "Learn practical self-defense techniques and situational awareness",
        level: "All Levels",
      },
      {
        _id: "5",
        ...
        instructor: "Sensei Mike",
        description:
          "Fun karate class for parents and children to train together",
        level: "Family",
      },
      {
        _id: "6",
      ...
      },
      {
        ...
        instructor: "Master Chen",
        description:
          "Prepare for upcoming kata competitions with advanced form training",
        level: "Intermediate",
      },
      {
        _id: "14",
      ...
      },
      {
        ...
        instructor: "Sensei Sarah",
        description:
          "Traditional weapons forms including bo staff and nunchaku",
        level: "Advanced",
      },
      {
        _id: "19",
  ...
  const specialEvents = [
    {
      ...
      time: "10:00 AM",
      instructor: "Master Chen",
      description: "Start the new year with martial arts",
      level: "Special",
    },
    {
      title: "Valentine's Day Couples Class",
      date: "2026-02-14",
      time: "7:00 PM",
      instructor: "Sensei Johnson",
      description: "Martial arts for couples",
      level: "Special",
    },
    {
      ...
      time: "9:00 AM",
      instructor: "All Instructors",
      description: "Week-long martial arts camp",
      level: "Camp",
    },
    {
      title: "Easter Egg Hunt Tournament",
      date: "2026-04-20",
      time: "2:00 PM",
      instructor: "All Instructors",
      description: "Fun tournament with prizes",
      level: "Special",
    },
    {
      title: "Mother's Day Self-Defense",
      date: "2026-05-11",
      time: "1:00 PM",
      instructor: "Sensei Williams",
      description: "Self-defense workshop for moms",
      level: "Special",
    },
    {
      title: "Father's Day Sparring",
      date: "2026-06-15",
      time: "2:00 PM",
      instructor: "Master Chen",
      description: "Father-child sparring session",
      level: "Special",
    },
    {
      title: "Independence Day Demo",
      date: "2026-07-04",
      time: "11:00 AM",
      instructor: "All Instructors",
      description: "Public martial arts demonstration",
      level: "Demo",
    },
    {
      ...
      time: "4:00 PM",
      instructor: "Sensei Davis",
      description: "Get ready for school year",
      level: "Youth",
    },
    {
      title: "Halloween Costume Tournament",
      date: "2026-10-31",
      time: "6:00 PM",
      instructor: "All Instructors",
      description: "Tournament in costume",
      level: "Special",
    },
    {
      title: "Thanksgiving Gratitude Class",
      date: "2026-11-26",
      time: "10:00 AM",
      instructor: "Master Chen",
      description: "Give thanks through martial arts",
      level: "Special",
    },
    {
      ...
      time: "7:00 PM",
      instructor: "All Instructors",
      description: "Annual holiday performance",
      level: "Performance",
    },
  ];
